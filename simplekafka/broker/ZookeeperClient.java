 ...
 */
public class ZookeeperClient implements Watcher { //implement Watcher interface by java API

    // logger for logging messages related to the ZookeeperClient class.
